...
class w9_1_ComponentEvent extends JFrame 
{
	...
	setTitle("This is a Frame");
        ...
        //ต้องใส่เซ็ตก่อนตลอด ไม่งั้นโปรแกรมไม่รัน
	...
	{ 
            ...
            //ใส่ RadioButton ลงไปในกรุ๊ปเดียวกัน
            bgroup.add( tb[i] );
            bpanel.add( tb[i] );
	}
	...
	contentpane.add(bpanel);
        ...
        //เรียก layout manager
        //คล้ายๆกับ commite ใน github ถ้าไม่ใส่ก้จะไม่มีการบันทึกไฟล์
	validate();
    }
